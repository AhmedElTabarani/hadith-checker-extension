...
const optionsContainerm = document.querySelector(
  '.mohdethen .options-container',
);
const searchBoxm = document.querySelector(
  '.mohdethen .search-box input',
);
const optionsListm = document.querySelectorAll('.mohdethen .option');

const selectedb = document.querySelector('.book .selected');
const optionsContainerb = document.querySelector(
